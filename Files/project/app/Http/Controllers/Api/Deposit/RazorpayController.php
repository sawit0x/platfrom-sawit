...
class RazorpayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $cancel_url = route('api.deposit.razorpay.cancel');
    ...
    public function notify(Request $request)
    {
        ...
        if ($success === true){
            ...
            return redirect()->route('api.user.deposit.confirm',$deposit->id)->with('success','Deposit amount '.$input['amount'].' ('.$input['currency_code'].') successfully!');

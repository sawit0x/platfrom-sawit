    ...
    public function store(Request $request) {
     ...
     public function notify(Request $request) {
        ...
        if($request->cancelled == "true"){
            return redirect()->route('api.user.deposit.confirm',$deposit->id)->with('success',__('Payment Cancelled!'));
        }
        ...
        if (isset($input['txref'])) {
            ...
            if ($resp['status'] == "success") {
              ...
              if (($chargeResponsecode == "00" || $chargeResponsecode == "0") && ($paymentStatus == "successful")) {
                ...
                return redirect()->route('api.user.deposit.confirm',$deposit->id)->with('error','Something went wrong!');
              }

...
class PaytmController extends Controller
{
    public function store(Request $request){
        ...
        $data_for_request = $this->handlePaytmRequest( $item_number, round($item_amount,2) );
    ...
    public function paytmCallback( Request $request ) {
        ...
        if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
            ...
            return redirect()->route('api.user.deposit.confirm',$deposit->id)->with('unsuccess', 'Payment Cancelled.');
        }
    }
}
